...
# source: llama2_tokenizer/sentencepiece_model.proto
...
TrainerSpec = _reflection.GeneratedProtocolMessageType('TrainerSpec', (_message.Message,), {
  ...
  '__module__' : 'llama2_tokenizer.sentencepiece_model_pb2'
